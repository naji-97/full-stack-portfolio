...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex h-[48px] w-full items-center justify-between rounded-md border border-white/10  px-4 py-5 text-base placeholder:text-white/10 focus:border-accent focus:outline-none bg-primary",
        className
      )}
      {...props}
    >
